...
:func:`~src.biochar_generator.generate_biochar` (convenience function) or
the lower-level :class:`~src.biochar_generator.BiocharGenerator` class.
...
For more control, use :class:`~src.biochar_generator.BiocharGenerator`
directly:
